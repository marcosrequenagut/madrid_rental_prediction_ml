...
distance_to_city_center = st.number_input("Distance to city center (km)", min_value=0.0, max_value=100.0, value=5.0)
distance_to_city_metro = st.number_input("Distance to metro (km)", min_value=0.0, max_value=100.0, value=5.0)
distance_to_city_castellana = st.number_input("Distance to castellana (km)", min_value=0.0, max_value=100.0, value=5.0)
